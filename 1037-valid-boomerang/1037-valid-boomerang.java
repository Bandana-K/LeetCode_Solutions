class Solution {
    public boolean isBoomerang(int[][] points) {
        ...
        // Given the 3 points, to check if they are not in same line, we can calculate the slope by taking any 2 set of points.
        ...
        double slope3 = Math.abs(1.0 * (points[0][1] - points[2][1])/(points[0][0] - points[2][0]));

        System.out.println("slope1 = " + slope1 + " slope2 = " + slope2 + " slope3 = " + slope3);
